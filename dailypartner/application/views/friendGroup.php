                        ...
                        foreach ($friendRequest as $friend) { ?>
                            <tr id=AddList<?= $friend->UID ?>>
                                ...
                                <td class="col-lg-8 col-xs-8">
                                    <p style="padding: 5px 8px; margin: 0;"><?= $friend->name . " ( " . $friend->ID . " ) "; ?></p>
                                    <p style="padding: 5px 8px; margin: 0;"><i class="fa fa-phone-square" aria-hidden="true"></i>&nbsp;<?= $friend->Tel; ?></p>
                                </td>
                    ...
                    <tr class="form-group" style="margin: 0; padding: 0">
                        ...
                        <th>
                                <span class="input-group-btn col-sm-4">
                                    <button class="btn btn-primary" type="button" onclick="Addgroup()">+
                                        Add group
                                    </button>
                                </span>
                        </th>
                                    ...
                                    <?php foreach ($groupList as $groupInfo) {
                                        for ($i = 0; $i < count($groupInfo); $i++) {
                                            ...
                                            <li role="presentation" id="<?= $groupInfo[$i]->gname; ?>"
                                                onclick=grouplistView("<?= $groupInfo[$i]->gname; ?>")>
