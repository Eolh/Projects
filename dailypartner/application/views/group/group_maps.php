...
<head>
    ...
    <script> gnum = "<?=$gnum ?>"; </script>
    <script src="/public/js/group_map.js"></script>
...
<!--    --><?php //require_once "application/views/main/common/rightSide_todo.php"; ?>
    ...
    <div id="MAP_CANVAS">
        ...
        <!--member-->
        <div id ="group_members" group="<?=$gnum;?>" >
            <div id="gruop_name" style="border: 1px;background-color: #00b3ee; width: 100%"><?=$gname;?></div>


            <?php
//            exit(var_dump($grouplist));
            foreach($grouplist as $member){  ?>
                <div id="<?=$member->id?>" class="group_member">
                    <h5><?=$member->name;?></h5>
