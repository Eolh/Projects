...
<head>
    ...
    <script type="text/javascript"
        src="https://maps.google.com/maps/api/js?v3.23&key=AIzaSyCYCSJRgNsqrQbsTQhw1FUb6FhhhZXI3y4&language=ja&libraries=places"
        async defer></script>
    ...
    <div class="background-texture">
        <div class="jumbotron row"
            ...
            <div class="col-sm-12 col-xs-12">
                <span id="briefing1" style="font-size: 25px;"></span>
                <span id='clock' style="color: #fff; border: 2px solid #e0e8e8; border-radius: 5px; padding: 0 4px; float: right; font-size: 30px;"><span>
            </div> <!--date, location, weather, time-->
            <!--<span style="text-align: right">time</span>-->
            <div id="briefing2" class="col-sm-7 col-xs-12"></div> <!--schedule-->
            <div id="briefing3" class="col-sm-5 col-xs-12" style="text-align: right; margin-top: 15px"></div> <!--number info-->
                    ...
                    <div class="col-sx-12 col-sm-6 col-lg-4 dashboard-right item">
                        <div class="col-sx-12 col-sm-12 col-lg-12 dashboard-box" id="dashboard-box-n5">
                            <div class="wiget panel" id="5">
                                <a href="/TodoList/"><p class="wiget-handle texture-img">ダイアリー</p></a>
